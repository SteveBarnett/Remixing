...
- this is an approach that (correctly) places the ad-tech industry on one side of a struggle, with advertisers (who are 
- being sold a defective product) and advertisees (that’s us, being spied upon and exploited) on the other side.
...
-There’s never just one ant. The likelihood that the only lie an Air Canada
- Those customer service reps—low-paid and ineffectual as they are—have repeatedly and sincerely tried to help me. When they
...
- The pivot to video was a cheap trick. Zuckerberg chose the victory condition
- defined the metric that proved the victory condition has been met (
- designed the system that determined the ability to attain the metric
- and then pulled the world’s least convincing rabbit out of his hat.
...
- The goal for Google, Facebook, Microsoft, Amazon, and Apple in spending so much to demonstrate that they 
- have a chance of conquering some part of the AI market is to convince Wall Street that they can continue to grow. 
...
- We can generalize an important point from this insight: If you want to puncture the
- AI bubble, you should train your fire on the applications that are used to justify the massive investment in data centers and training.
...
- Combine this with another cognitive trap, the “availability heuristic” (we overestimate the likelihood of things we can most easily imagine), and it would be very easy for
- coders working with LLMs to systematically overestimate how useful these tools are.
