...
Something like yield too. Like bend, bear. Using Using softness, sensitivity and calmness. Keeping things as much intact as possible for everyone.
...
- Practice
    ...
    - A realign and remix (of [Valued Action: POCK](#valued-action-pock)?) after some big life changes?
        - Notice the polarities and the risks/rewards of neglecting/focusing on each one. (Like [What to do of Tension](/thinking/tension/#what-to-do))
    - Back into Zen, start with [Bearing Witness](https://www.goodreads.com/book/show/279154.Bearing_Witness)
    - Metta month
...
- Health
    - Keep the alternating exercising going
- Interests
    - Cthulhu Critters
