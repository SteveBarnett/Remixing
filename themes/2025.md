...
- Work
    - NZSL booklet
    - Plot out Team Day talk for A11y Ready for DS
    - Plot out Team Day talk for IVR audit
- Interests
    - Waves! Big page, busy page, drawings from Hamonshu, Seigaiha, Sensitive Chaos, Crystal & Dragon, Patterns in Nature, Waves Atlas
    - Watch [How To Draw Towns and Cities for Fantasy Maps! video](https://www.youtube.com/watch?v=GDkWfgSOjBE) (11m)
    - Clear out bookshelves, donate some
    - Sketch project: maps, islands, towns, archipelago, cross-sections?
    ...
    - Star some music tracks, update listing
    - Fuzzy edge circles, no crispy lines, Vennish
...
- Practice
    ...
    - The Dao of Capybaras
    - Notes of the mutability of (my own) self and identity
    - Consider: Challenge vs Difficulty vs Constraints
    - Use 2&times;2 quadrants more
